...
_G.packer_plugins = {
  ...
  ["dracula.nvim"] = {
    loaded = true,
    path = "/home/rafa/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/home/rafa/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["nvim-surround"] = {
    loaded = true,
    path = "/home/rafa/.local/share/nvim/site/pack/packer/start/nvim-surround",
